...
{ { 9, 21, 52 }, { 8, 41, 62 }, { 22, 53, 69 }, { 10, 50, 74 } },            // YES Panel 1
{ { 9, 42, 68 }, { 26, 63, 61 }, { 24, 44, 72 }, { 23, 46, 74 } },           // YES Panel 2
{ { 21, 37, 67 }, { 9, 19, 47 }, { 21, 52, 73 }, { 21, 49, 69 } },   // YES Panel 3
{ { 19, 36, 62 }, { 35, 61, 68 }, { 18, 37, 64 }, { 8, 38, 40 } } }; // YES Panel 4
int roadsNo_AllPanels[ 5 ][ 4 ][ 3 ] = {
{ { 9, 84, 129 }, { 83, 112, 140 }, { 82, 98, 113 }, { 85, 95, 120 } },      // NO Panel Proto
{ { 9, 116, 124 }, { 100, 114, 138 }, { 98, 118, 143 }, { 101, 128, 134 } }, // NO Panel 1
{ { 85, 113, 137 }, { 100, 128, 144 }, { 86, 97, 122 },{ 85, 127, 141 } },     // NO Panel 2
{ { 98, 112, 121 }, { 97, 114, 148 }, { 111, 136, 139 },{ 97, 119, 116 } },     // NO Panel 3
{ { 95, 123, 145 }, { 111, 126, 148 }, { 84, 113, 121 },{ 95, 124, 144 } } };   // NO Panel 4
int mappingOffset_AllPanels[ 5 ] = { 75 , 74 , 75 , 75 , 76 };           // proto, 1, 2, 3, 4
